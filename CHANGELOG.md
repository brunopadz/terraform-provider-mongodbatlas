...
- Still cannot create cluster in region ME\_SOUTH\_1 on plugin version 0.4.1 [\#161](https://github.com/terraform-providers/terraform-provider-mongodbatlas/issues/161)
- mongoatlas\_cluster fails to create  - invalid enumeration value M2 was specified  [\#160](https://github.com/terraform-providers/terraform-provider-mongodbatlas/issues/160)
...
- feature: add default label to clusters [\#163](https://github.com/terraform-providers/terraform-provider-mongodbatlas/pull/163) ([marinsalinas](https://github.com/marinsalinas))
